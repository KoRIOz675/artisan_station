<div class="container create-product-container" style="max-width: 800px; margin: 30px auto; padding: 20px; background-color: #f8f9fa; border: 1px solid #dee2e6; border-radius: 5px;">
    ...
    <form action="<?php echo URLROOT; ?>/products/store" method="post" novalidate enctype="multipart/form-data">
        ...
        <div class="form-group" style="margin-bottom: 15px; display: flex; flex-direction: column;">
            ...
            <textarea name="description" id="description" style="margin: 0 1em; border: 1px solid #800000; border-radius: 5px; height: 180px; padding: 8px 8px; font-size: medium; resize: vertical; font-family: Alata, sans-serif;" class="form-control <?php echo (!empty($data['description_err'])) ? 'is-invalid' : ''; ?>" rows="6" required><?php echo htmlspecialchars($data['description']); ?></textarea>
        ...
        <div class="form-group" style="margin-bottom: 15px; display: flex; flex-direction: column;">
            ...
            <input type="number" name="price" id="price" style="margin: 0 1em; border: 1px solid #800000; border-radius: 5px; height: 30px; padding: 0 8px; font-size: medium; font-family: Alata, sans-serif;" step="0.01" min="0" class="form-control <?php echo (!empty($data['price_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo htmlspecialchars($data['price']); ?>" required>
        ...
        <div class="form-group" style="margin-bottom: 15px; display: flex; flex-direction: column;">
            ...
            <input type="number" name="stock_quantity" style="margin: 0 1em; border: 1px solid #800000; border-radius: 5px; height: 30px; padding: 0 8px; font-size: medium; font-family: Alata, sans-serif;" id="stock_quantity" step="1" min="0" class="form-control <?php echo (!empty($data['stock_quantity_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo htmlspecialchars($data['stock_quantity'] ?? '1'); ?>" required> <?php // Default value 1 in HTML 
                                                                                                                                                                                                                                                                                                                                                                                                                                    ?>
        ...
        <div class="form-group" style="margin-bottom: 15px; display: flex; flex-direction: column;">
            ...
            <select name="category_id" id="category_id" style="margin: 0 1em; border: 1px solid #800000; border-radius: 5px; height: 30px; padding: 0 8px; font-size: medium; font-family: Alata, sans-serif;" class="form-control <?php echo (!empty($data['category_id_err'])) ? 'is-invalid' : ''; ?>" required>
        ...
        <div class="form-group">
            ...
            <a href="<?php echo URLROOT; ?>/users/dashboard#art-content" class="btn btn-secondary">Cancel</a>
        </div>
